...
import { HomeAdvertisingCard } from "./home-advertising-card";
...
interface HomePostsSectionProps {
  ...
  advertising: AdvertisingDirectusTypeData;
}

export function HomePostsSection({ featuredPost, recentPosts, postsHome, advertising }: HomePostsSectionProps) {
  ...
  const advertisingCard = advertising.data[0];
    ...
    <section className="mt-6 w-full">
      <div className="grid w-full grid-cols-12 gap-4">
        <div className="col-span-12 flex flex-col gap-4 lg:col-span-4">
          ...
          {advertisingCard && <HomeAdvertisingCard advertising={advertisingCard} />}
        </div>
