...
export default function Footer() {
  return (
    <footer className="halftone-blue-no-border border-oliver-dark my-0 flex h-20 w-full items-center justify-center border-t-[2px] p-0 px-10 text-[0.8rem] md:h-10 md:text-[1rem]">
