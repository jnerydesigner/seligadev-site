...
export function LastPostBlog() {
  return (
    <div className="div-posts-path h-[200px] p-4 z-10 mt-[-40px] flex items-center gap-4 ">
      ...
      <Link
        href="#"
        className="flex-1 z-10 h-[100px] flex items-center p-10 gap-4 mt-12"
      >
        ...
        <div className="flex-1">
          ...
          <p className="text-sm line-clamp-2">
            ...
            doloremque sint quam beatae tenetur eum porro ipsa, molestiae illum
            itaque et odit? Nisi libero deserunt, rerum tempore nostrum numquam
            adipisci?
          </p>
        </div>
      </Link>
